...
export const LOGO_PRODUCT_CODE = "PRD-LOGO-FRONTLIT-PLEXI-AL06";

/**
 * LEGACY_NAMING_DEBT: ProductAggregate.inscription is the generic display
 * designation for this product. The operator label is "Denumire logo".
 * This wave does not add root.designation.
 */
export const logoFrontlitPlexiAl06Template: ProductTemplate = {
  code: LOGO_PRODUCT_CODE,
  version: "1",
  familyId: LIGHTED_VOLUMETRIC_SIGNS_FAMILY_ID,
  categoryId: FRONT_LIT_VOLUMETRIC_LOGO_CATEGORY_ID,
  label: "Logo volumetric luminos",
  description:
    "Logo volumetric luminos cu iluminare frontală, față din plexiglas 3 mm opal, volum din aluminiu 0,6 mm și spate din forex 10 mm. Set omogen: suprafața și perimetrul sunt totaluri confirmate pentru întregul logo.",
  identityFacts: [
  ...
  formSchemaId: "prd-logo-frontlit-plexi-al06-form-v1",
  status: "PILOT",
  components: [
...
export const logoFrontlitPlexiAl06FormSchema: FormSchema = {
  id: "prd-logo-frontlit-plexi-al06-form-v1",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          min: 1,
          visibleWhen: { kind: "always" },
          hint: "Suprafață totală confirmată pentru întregul set de logo. Nu este geometrie calculată de WorkOS. Spatele folosește aceeași suprafață.",
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          min: 1,
          visibleWhen: { kind: "always" },
          hint: "Perimetru total de fabricație confirmat pentru întregul set de logo. Nu este geometrie calculată de WorkOS.",
        },
      ],
    },
  ],
