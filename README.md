...
Standalone CF5 is not required before Letters. Remaining Configuration-First work is domain-by-domain when required. Letters implementation is not authorized.
