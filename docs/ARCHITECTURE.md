...
Standalone CF5 is not required before Letters. Remaining Configuration-First work is domain-by-domain when required. Letters Product Truth V1 is the living next program and is not authorized by this document.
