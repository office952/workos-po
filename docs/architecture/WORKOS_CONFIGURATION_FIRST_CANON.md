...
Letters Product Truth V1 and ACM Product Truth V1 are complete. This document does not authorize member DAG, execution expansion, planning/capacity, CF5, or any other next wave.
