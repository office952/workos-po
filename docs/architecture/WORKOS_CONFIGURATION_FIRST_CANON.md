...
- `docs/architecture/PLANNING_CAPACITY_V1_CANON.md` ? single Planning / Capacity V1 contract
...
CAPACITY_IMPLEMENTATION = NOT_AUTHORIZED_BY_THIS_DOCUMENT
PLANNING_CAPACITY_CANON = docs/architecture/PLANNING_CAPACITY_V1_CANON.md
NEXT_WAVE_AUTHORIZED = NO
FORMULA_CONFIGURABILITY_FULLY_DELIVERED = NO
```
