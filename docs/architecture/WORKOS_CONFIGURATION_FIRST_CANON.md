...
CURRENT_PROGRAM = PEOPLE_AND_MACHINE_ADMIN_V1
CURRENT_PROGRAM_STATUS = COMPLETE
NEXT_PROGRAM = EXECUTION_EXPANSION_V1
NEXT_PROGRAM_SELECTION = EXECUTION_EXPANSION_V1
NEXT_PROGRAM_STATUS = PREFLIGHT_REQUIRED
STANDALONE_CF5_REQUIRED_BEFORE_LETTERS = NO
```
...
Letters Product Truth V1, ACM Product Truth V1, Product Enablement Admin V1, and People and Machine Admin V1 are complete. Product Enablement is domain-owned organization configuration, not CF5. Living next program is Execution Expansion V1. This document does not authorize implementation.
